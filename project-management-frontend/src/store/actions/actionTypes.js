...
export const EDIT_SCOREBOARD_START = 'EDIT_SCOREBOARD_START';
export const EDIT_OBJECTIVE_NARRATIVE_SUCCESS = 'EDIT_OBJECTIVE_NARRATIVE_SUCCESS';
export const EDIT_RISK_NARRATIVE_SUCCESS = 'EDIT_RISK_NARRATIVE_SUCCESS';
export const EDIT_ACTION_NARRATIVE_SUCCESS = 'EDIT_ACTION_NARRATIVE_SUCCESS';
export const EDIT_SCOREBOARD_FAIL = 'EDIT_SCOREBOARD_FAIL';
