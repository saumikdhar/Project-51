    ...
    return (
      <Modal
        ...
        footer={[
          ...
          <Button key="submit" type="primary" form="AddUserForm" htmlType="submit">{"Add"}</Button>
        ]}>
        <Form id="AddUserForm" layout='vertical' onFinish={this.onSubmit}>
          ...
          <FormItem
            ...
            name="password"
            rules={[
              {required: true, message: 'Please enter the new user\'s password'}
            ]}
          >
          ...
          >
            <Select>
              <Option key={"ProjectManager"} value={"ProjectManager"}>{"Project Manager"}</Option>
